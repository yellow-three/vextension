...
use YellowThree\VoyagerExtension\FilePond;
...
class FilePondController extends BaseController
{
    ...
    {
        $input = $request->file(config('vextension.filepond.input_name'));
        ...
        $path = config('vextension.filepond.temporary_files_path', 'filepond');
        $disk = config('vextension.filepond.temporary_files_disk', 'local');
    ...
    public function chunk(Request $request)
    {
        ...
        $basePath = config('vextension.filepond.chunks_path').DIRECTORY_SEPARATOR.$id;
